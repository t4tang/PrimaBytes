<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ds-prj01.aspx.cs" Inherits="PRIMA_HRIS.Page.DS.Project.ds_prj01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  class="scroller" runat="server" style="overflow-y:auto; height:575px; font-size:small; font-family:Tahoma; background-color:#303d3f">
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Auto" AllowPaging="True" PageSize="10" 
            ...
            Skin ="Glow" OnItemCreated ="RadGrid1_ItemCreated"
            AllowSorting="True">
            ...
            <MasterTableView CommandItemDisplay="Bottom" Font-Size="11px" Font-Names="Tahoma" DataKeyNames="LocationCode" EditMode="EditForms" 

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ga-tkt02.aspx.cs" Inherits="PRIMA_HRIS.Page.GA.Ticket.Issued.ga_tkt02" %>
        ...
        <div runat="server" style="width:100%; overflow-y:hidden; background-color:#303d3f"> 
            <telerik:RadGrid  RenderMode="Auto" ID="RadGrid1"  runat="server" AllowPaging="true" ShowFooter="false" Skin="Glow" 
                ...
                <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="tr_code" HeaderText="Transaction" DataField="trCode"
                            ItemStyle-Width="80px" FilterControlWidth="80" ItemStyle-HorizontalAlign="Center">
                            <HeaderStyle Width="100px" HorizontalAlign="Center"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridDateTimeColumn UniqueName="trDate" HeaderText="Issued Date" DataField="trDate" ItemStyle-Width="70px" 
                        ...
                        <telerik:GridBoundColumn UniqueName="reffNo" HeaderText="Request No" DataField="reffNo"
                            ItemStyle-Width="80px" FilterControlWidth="80" ItemStyle-HorizontalAlign="Center">
                            <HeaderStyle Width="100px" HorizontalAlign="Center"></HeaderStyle>
                        </telerik:GridBoundColumn>  
                        <telerik:GridBoundColumn UniqueName="FirstName" HeaderText="Employee Name" DataField="FirstName"
                        ...
                        <telerik:GridBoundColumn UniqueName="PositionName" HeaderText="Jabatan" DataField="PositionName" Visible="false"
                        ...
                        <telerik:GridBoundColumn UniqueName="route" HeaderText="Route" DataField="route" 
                                ItemStyle-Width="100px" FilterControlWidth="100px">
                            <HeaderStyle Width="120px" HorizontalAlign="Left"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridDateTimeColumn UniqueName="DepartureDate" HeaderText="Departure Date" DataField="DepartureDate" ItemStyle-Width="70px" 
                                EnableRangeFiltering="false" FilterControlWidth="70px" PickerType="DatePicker" ItemStyle-HorizontalAlign="Center"
                            DataFormatString="{0:d}" >
                            <HeaderStyle Width="90px" HorizontalAlign="Center"></HeaderStyle>
                        </telerik:GridDateTimeColumn>                 
                        <telerik:GridBoundColumn UniqueName="invNo" HeaderText="Invoice Number" DataField="invNo" Visible="true" 
                                ItemStyle-Width="130px" FilterControlWidth="130">
